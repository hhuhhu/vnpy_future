...
if __name__ == '__main__':
    ...
    # 设置回测用的数据起始日期
    engine.setStartDate('20161104')
    engine.setEndDate('20180101')
    # 设置产品相关参数
    engine.setSlippage(1)     # rb一个价格变动单位
    engine.setRate(1.01/10000)   # 万1.01
    engine.setSize(10)         # rb合约大小
    engine.setPriceTick(1)    # rb最小价格变动单位
    
    # 设置使用的历史数据库
    engine.setDatabase(FUTURE_1MIN, 'RB1801')
