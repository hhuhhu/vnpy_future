...
from PriceSignal import *
from IndicatorSignal import *
import random
...
if __name__ == '__main__':
    ...
    reader.read_csv(["../Data/TestData/XAUUSD1.csv", "../Data/TestData/GBPUSD1.csv"], start='2015.01.01',
                    end='2016.01.01', symbol_name=["XAUUSD", "GBPUSD"], skiprows=2000000)

    opt = IndicatorOptimize(reader.data["XAUUSD"], 'close', 7)
