...
class ResidualACTCore(rnn_core.RNNCore):
    ...
    * `act_out` is the weighted average output of all pondering steps (see ACT
    ...
    def _body(self,
        ...
        next_memory, next_read_weightings, next_write_weightings, next_precedence_weightings, next_link, next_usage = next_access_state
        ...
        p_next_access_state = (p_next_memory,
...
class ACTCore(rnn_core.RNNCore):
    ...
    * `act_out` is the weighted average output of all pondering steps (see ACT
    ...
    def _body(self,
        ...
        prev_memory, prev_read_weightings, prev_write_weightings, prev_precedence_weightings, prev_link, prev_usage = prev_access_state
...
class update_Dynamic_memory_allocation(RNNCore):
    ...
    *   Decreased by reading, where usage is decreased after reading from a
    ...
    def _build(self,
        ...
        allocation_weightings = self._update_allocation_weightings(usage,
                                                                   write_gates,
                                                                   num_writes)
    ...
    def _update_write_weightings(self,
        ...
        with tf.name_scope('update_write_weightings', values=[tape, prev_memory, prev_usage]):
            ...
            write_weightings = write_gates * (
                allocation_gates * write_allocation_weightings + (1 - allocation_gates) * write_content_weightings)
...
class DNCore_L1(RNNCore):
    ...
    def __init__(self,
        ...
        self._dnc_output_size = hidden_size + num_read_heads * word_size
...
class DNCore_L3(RNNCore):
    ...
    def __init__(self,
        ...
        self._dnc_output_size = hidden_size * 3 + num_read_heads * word_size
        self._num_read_heads = num_read_heads
        self._word_size = word_size
