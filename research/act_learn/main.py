...
from research.act_learn.util import get_config,ptb_raw_data,save_load,run_epoch
from research.act_learn.act_model import ACTModel
    ...
    with tf.Graph().as_default(), tf.Session() as session:
        ...
        with tf.variable_scope('model', reuse=None, initializer=initialiser):
            ...
            if saved_model_path is not None:
                save_load(saved_model_path, session)
        ...
        for i in range(config.max_max_epoch):
            ...
            if weights_dir is not None:
                ...
                save_load(weights_dir + "/Epoch_{:02}Train_{:0.3f}Val_{:0.3f}date{}.pkl"
...
if __name__ == '__main__':
    ...
    flags.DEFINE_string("data_path", sys.path[0]+'/ptb/', "data_path")
