...
class BacktestingEngine(object):
    ...
    def __init__(self):
        ...
        self.workingStopOrderDict = OrderedDict()  # 停止单撤销后会从本字典中删除
    ...
    def crossLimitOrder(self):
        ...
        temp = copy.deepcopy(self.workingLimitOrderDict)
        for orderID, order in temp.items():
    ...
    def crossStopOrder(self):
        ...
        # 遍历停止单字典中的所有停止单
        # print("workingStopOrderDict: ", self.workingStopOrderDict)
        # woring_stop_order_dict = copy.deepcopy(self.workingStopOrderDict)
    ...
    def showBacktestingResult(self):
        ...
        print("length: ", len(tradeTimeIndex))
        print("tradeTimeIndex: ", tradeTimeIndex)
