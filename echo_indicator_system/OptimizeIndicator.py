...
from echo_indicator_system.IndicatorAnalyst import *
from echo_indicator_system.IndicatorSignal import *
from echo_indicator_system.PriceSignal import *
# 创建适应度类为求最小值
...
class IndicatorOptimize(object):
    ...
    def __init__(self, time_series, apply_price, process_num):
        ...
        self.signal, self.signal_bin = piecewise_linear(self._time_series[apply_price], 3, convert_trading_signals=False)
    ...
    def plot_indicator_signal(self, apply_price, ind_func, *args):
        ...
        signal_pos = ind_func(self._apply_price, *args)
...
if __name__ == '__main__':
    ...
    # test = opt.init_evolution(mu, lambda_, cxpb, mutpb, ngen)
    # print('test: {}'.format(test[0]))
    test = [185, 94, -4.116770883207499, -0.31599494023125096, -4.1804820186237857, -0.42089220118222848, 6.0299954556902104, 5.8770946919834834]
    opt.plot_indicator_signal('close', ma_cross, *test)
